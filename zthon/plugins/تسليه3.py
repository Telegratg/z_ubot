...
@zedub.zed_cmd(pattern=r"مكعبات$")
async def _(event):
    if event.fwd_from:
        return
...
@zedub.zed_cmd(pattern=r"النضام الشمسي$")
async def _(event):
    if event.fwd_from:
        return
