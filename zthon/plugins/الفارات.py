...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if gvarstatus("MAX_FLOOD_IN_PMS") is None:
            await zed.edit(
                "**✾╎تم تغييـر {} بنجـاح ☑️**\n\n**✾╎المتغيـر : ↶**\n `{}`\n**✾╎ارسـل الان** `.الحمايه تفعيل`".format(
                    input_str, vinfo
                )
            )
        else:
        ...
        if input_str:
            return await zed.edit(
                "**✾╎عـذراً .. لايوجـد هنالك فـار بإسـم {} ؟!.. ارسـل (.اوامر الفارات) لـعرض قائمـة الفـارات**".format(
                    input_str
                )
            )
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if gvarstatus("ALIVE_TEMPLATE") is None:
            return await zed.edit(
                "**✾╎عـذراً عـزيـزي .. انت لـم تقـم باضـافـة فـار {} اصـلاً...**".format(
                    input_str
                )
            )
        await zed.edit(
...
async def _(malatha):
    ...
    if malatha.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            await zed.edit(f"**✾╎تم تحميل {downloaded_file_name} في وقت {ms} ثانيه.**")
